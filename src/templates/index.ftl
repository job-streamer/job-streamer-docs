...
<@layout.myLayout>
  ...
  <section class="ui one column centered grid">
    <div class="column">
        ...
        Agent is a job execution agent in JobStreamer. At the moment you start the virtual image without any configuration or deploy, it will be a execution server. So you can scale out easily according to the loading amount.<br/>
